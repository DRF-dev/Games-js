...
interface states{
    nosJeux:Array<Object>,
    objetEnCours: { name: string, proprio:string, neuf:Boolean}
}

export default class Liste extends React.Component<{},states>{
    ...
    changeJeu = (e)=>{
        const etat:{ nosJeux:any, objetEnCours:any } = this.state;
        this.setState({
            ...etat.nosJeux,
            objetEnCours:{
                ...etat.objetEnCours,
    ...
    check = (e:any)=>{
        const checkTrue = document.getElementById('checkTrue') as HTMLInputElement
        const checkFalse = document.getElementById('checkFalse') as HTMLInputElement
        const etat = this.state;
                    ...
                    <div className="row m-3">
                        ...
                        <div className="col-12 col-md-6 ml-md-5">
                            ...
                            <div className="list-group-flush">
                                {this.state.nosJeux.map((item:{_id:string, name:string})=>{
                                    return(
